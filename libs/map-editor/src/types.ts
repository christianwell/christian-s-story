...
export enum GameMapProperties {
    ...
    STORY_TEXT_POSITION = "storyTextPosition",
    STORY_TEXT_DURATION = "storyTextDuration",
    STORY_TEXT_STYLE = "storyTextStyle",
    STORY_TEXT_COLOR = "storyTextColor",
    STORY_TEXT_SIZE = "storyTextSize",
    STORY_VIDEO = "storyVideo",
    STORY_VIDEO_SKIPPABLE = "storyVideoSkippable",
    STORY_MUSIC = "storyMusic",
    STORY_MUSIC_LOOP = "storyMusicLoop",
    STORY_SET_FLAG = "storySetFlag",
    STORY_REQUIRE_FLAG = "storyRequireFlag",
    STORY_ONCE = "storyOnce",
    STORY_FADE_IN = "storyFadeIn",
    STORY_FADE_OUT = "storyFadeOut",
    STORY_LETTERBOX = "storyLetterbox",
    STORY_TRIGGER = "storyTrigger",
    STORY_TRIGGER_MESSAGE = "storyTriggerMessage",
}
